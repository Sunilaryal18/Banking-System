    ...
    SavingTransaction::SavingTransaction(const string HOST,
       ...
       const string DATABASE)
    {
       ...
       db_conn = mysql_real_connect(db_conn, HOST.c_str(),USER.c_str(), PASSWORD.c_str(), DATABASE.c_str(), 0,
             NULL, 0);
       if(!db_conn)
    ...
    SavingAccount* SavingTransaction::getAccount(int acno)
    {
    ...
    void SavingTransaction::withdraw(int acno, double amount)
    {
       SavingAccount* b = getAccount(acno);
       if(b != NULL) {
    ...
    void SavingTransaction::deposit(int acno, double amount)
    {
       stringstream sql;
    ...
    void SavingTransaction::createAccount(SavingAccount* ba)
    {
       stringstream ss;
    ...
    void SavingTransaction::closeAccount(int acno)
    {
       stringstream ss;
    ...
    void SavingTransaction::message(string msg)
    {
       cout << msg << endl;
    }
    void SavingTransaction::printAllAccounts()
    {
       MYSQL_RES* rset;
       MYSQL_ROW rows;
